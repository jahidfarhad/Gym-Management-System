...
<button class="btn  my-5"><a href="Add_user_by_admin.php" class="Add_member_in_Admin_dashboard  btn_add text-light">Add Member</a></button>
      ...
      if($result){
            while($row=mysqli_fetch_assoc($result)){
              ...
              <td>'.$Password.'</td>
                ...
                <a href="Member_Delete.php? deleteid='.$Member_Code.'" class="btnDeleteMember Display_member_Details_update_delete_button"><i class="fas fa-trash"></i></a></i>
                </td>
              </tr>';
            }
        }
